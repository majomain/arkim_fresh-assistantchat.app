...
sed -i "s|<NEXT_PUBLIC_ENVIRONMENT>|${BITBUCKET_DEPLOYMENT_ENVIRONMENT}|g" .env
sed -i "s|<NEXT_PUBLIC_COGNITO_ISSUER_URL>|${COGNITO_ISSUER_URL}|g" .env
sed -i "s|<NEXT_PUBLIC_COGNITO_APP_CLIENT_ID>|${COGNITO_CLIENT_ID}|g" .env
