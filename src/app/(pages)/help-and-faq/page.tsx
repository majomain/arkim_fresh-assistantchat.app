                            ...
                            <AccordionItem defaultOpen={false}>
                                <AccordionHeader>
                                    <p className="font-semibold">
                                        How to onboard a new asset?
                                    </p>
                                </AccordionHeader>
                                <AccordionContent>
                                    <div className="bg-background border rounded-md p-2 mb-2">
                                        <p className="text-sm">
                                            Follow the steps to onboard a new
                                            asset
                                        </p>
                                        <ul className="list-disc list-outside px-7 py-2">
                                            <li className="text-sm">
                                                Open the onboard asset card
                                            </li>
                                            <li className="text-sm">
                                                Fill up the required fields
                                            </li>
                                            <li className="text-sm">
                                                Hit onboard to finish up the
                                                process
                                            </li>
                                        </ul>
                                        <p className="text-sm my-3">
                                            If asset already exist in your asset
                                            list(check in sidebar) then system
                                            will ask you to access that one or
                                            else if access the newly onboarded
                                            asset.
                                        </p>
                                    </div>
                                </AccordionContent>
