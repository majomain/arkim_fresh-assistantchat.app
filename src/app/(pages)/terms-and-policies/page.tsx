...
export default function TermsAndPoliciesPage() {
    ...
    return <div className="w-full md:w-3xl lg:w-5xl mx-auto px-2">
        ...
        <p className="text-4xl font-semibold text-center">Terms & Policies</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mt-20">
            <div className="flex flex-col bento p-5">
                ...
                <ul className="list-disc list-outside px-7 py-2 text-sm">
                    <li>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vel, repellat.</li>
                    <li>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eum ad tempore ducimus, repellendus excepturi temporibus?</li>
                    <li>Lorem ipsum dolor sit amet.</li>
                    <li>Lorem ipsum dolor sit amet consectetur adipisicing elit.</li>
                    <li>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Suscipit, quod.</li>
                </ul>
            </div>

            <div className="flex flex-col bento p-5">
                <p className="text-xl font-semibold text-primary">Policies</p>
                <ul className="list-disc list-outside px-7 py-2 text-sm">
                    <li>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vel, repellat.</li>
                    <li>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eum ad tempore ducimus, repellendus excepturi temporibus?</li>
                    <li>Lorem ipsum dolor sit amet.</li>
