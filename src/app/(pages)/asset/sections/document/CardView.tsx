...
export default function CardView(
    ...
    return <div className="md:hidden">
        <CardWithPagination
            ...
            renderCard={(doc) => <div key={doc.documentId}
            ...
            emptyState={
                <div className="w-full flex flex-col items-center p-5 mt-5 gap-4">
                    <FileStack className="text-muted-foreground w-15 h-15" strokeWidth={1} />
                    <div className="flex flex-col items-center">
                        <p className="text-base font-semibold">No Document Found</p>
                        <p className="text-sm text-muted-foreground text-center">Uploaded documents will appear here</p>
                    </div>
                </div>
            }
        />
