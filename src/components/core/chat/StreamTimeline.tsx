                ...
                >
                    {steps.length === 0 ? (
                            ...
                            {[0, 1, 2].map((i) => (
                                <span
                                    ...
                                    style={{
                                        ...
                                        animation:
                                            'thinking-dot 1.2s ease-in-out infinite',
                        ...
                        steps.map((step, index) => {
                            const isDone =
                                index < steps.length - 1 || hasResponseArrived;
                            const isActive =
    ...
    return (
        <div
            style={{
                ...
                gap: 10,
                animation: isVisible
                    ? 'step-in 0.3s ease-out forwards'
                    : 'none',
            ...
            {isDone ? (
                ...
                <span
                    style={{
                        ...
                        marginTop: 1,
                        animation:
                            'pop-check 0.35s cubic-bezier(.36,.07,.19,.97) forwards',
                        animationFillMode: 'both',
                    }}
                >
                    <Check
                        size={10}
                        style={{ color: 'var(--st-done)', strokeWidth: 2.5 }}
                    />
                </span>
            ) : isActive ? (
