...
export default function WorkLogDialog({
    workOrder,
    children,
}: {
                                    ...
                                    >
                                        ...
                                        <AccordionContent smoothHide={true}>
                                            <div className="bg-muted/30 flex flex-col gap-3 mb-2 pt-4 pb-2 px-2 rounded-md">
                                                ...
                                                {workLog.troubleshootingSteps && (
                                                    <div className="flex flex-col gap-2">
                                                        <Separator className="mb-2" />
                                                        <p className="text-xs font-semibold text-muted-foreground flex flex-row items-center gap-1">
                                                                            ...
                                                                            {workLog.parts.map(
                                                                                (
                                                                                    ...
                                                                                    return (
                                                                                        <div
                                                                                            key={`part-${index}-${idx}`}
                                                                                            className="bg-card p-2 rounded-md flex flex-col gap-2"
                                                                                        >
                                                                                            <div className="grid grid-cols-2 gap-5">
                                                                                                <p className="text-xs font-semibold text-muted-foreground flex flex-col gap-1">
                                                                                                    Manufacturer
