...
function SelectTrigger({
    ...
    return (
        <SelectPrimitive.Trigger
            ...
            className={cn(
                // Layout & base
                'flex w-fit items-center justify-between gap-2 rounded-md border bg-transparent px-3 py-2 text-sm whitespace-nowrap outline-none',
                // Sizing
                ...
                "[&_svg:not([class*='text-'])]:transition-colors",
                "focus-visible:[&_svg:not([class*='text-'])]:text-foreground",
                className,
            )}
            {...props}
        >
            ...
            <SelectPrimitive.Icon asChild>
                {/* Chevron: muted by default, foreground when trigger is focused/open */}
                <ChevronDownIcon className="size-4 text-muted-foreground transition-colors opacity-50" />
        ...
        >
            <span className="absolute right-2 flex size-3.5 items-center justify-center">
                <SelectPrimitive.ItemIndicator>
                    {/* Check icon gets accent color when item is selected+focused */}
...
function SelectScrollUpButton({
    ...
    return (
        <SelectPrimitive.ScrollUpButton
            ...
            {...props}
        >
            {/* Scroll chevrons are purely decorative — kept muted intentionally */}
